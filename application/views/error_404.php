                    ...
                    <div class="col-lg-4 col-md-6 col-10 p-0">
                        ...
                        <div class="card-content">
                            ...
                            <div class="row py-2 text-center">
                                <div class="col-12">
                                    <a href="<?=base_url()?>" class="btn btn-white danger box-shadow-4"><i class="ft-home"></i> Back to Dashboard</a>
                                </div>
                        ...
                        <div class="card-footer bg-transparent">
                            <div class="row">
                                <p class="text-muted text-center col-12 py-1 white">© <span class="year"></span> <a href="#" class="white text-bold-700"><?=$comp?> </a>Crafted with <i class="ft-heart white "> </i> </p>
