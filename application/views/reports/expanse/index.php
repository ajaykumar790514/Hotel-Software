                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <input type="date"  class="form-control input-sm" name="end_date" >
                                    ...
                                    <div class="col-md-2">
                                      <div class="form-group">
                                      <label for="expense_master">Expanse Type</label>
                                      <select autocomplete="false"  name="expense_master" id="expense_master" class="form-control input-sm">
                                      <?php
                                      echo optionStatus('', '-- Select --', 1);
                                      foreach ($expense_master as $row) {
