...
<div class="app-content content">
    ...
    <!-- form -->
    <form class="form ajaxsubmit" action="<?=$action_url?>" method="POST" enctype="multipart/form-data">
        <div class="form-body">
            <h4 class="form-section">
                <i class="la la-building"></i> Website Property</h4>
            <div class="form-group">
                <label for="heading">Heading</label>
                <input type="text" id="heading" class="form-control" placeholder="Heading" name="heading" >
            </div>

            <div class="form-group">
                <label for="subHeading">Sub. Heading</label>
                <input type="text" id="subHeading" class="form-control" placeholder="Sub. Heading" name="subHeading" >
            </div>
            <div class="row">
                <div class="col-md-12">
                   <label for="managername">Salected Property</label>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <input type="hidden" name="flat_idsss" id="flat_idsss" value=",">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <!-- <div class="col-md-6 flat">
                    <div class="form-group">
                        ...
                        //    echo checkbox('flat_ids[]',$row->flat_id,$fname,$row->status); 
                        // echo "</li>";
