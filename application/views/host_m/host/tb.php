           ...
           <tbody>
               ...
               <tr>
                   ...
                   <td>
					...
					<a href="<?=base_url()?>host/propaccess-list/<?=$row->id?>" class="btn btn-primary btn-sm">Manage Property</a>
                    <!-- <a href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever="Property Access - <?=$row->name?>" data-url="<?=base_url()?>host/propaccess/<?=$row->id?>" class="btn btn-primary btn-sm">Manage Property</a> -->
                   </td>
                   <td><?=$row->username?></td>
                   <td><?=$row->mobile?></td>
                   ...
                   <td>
                       ...
                       <a href="javascript:void(0)" onclick="_delete(this)" url="<?=$delete_url?><?=$row->id?>" title="Delete" >
                           <i class="la la-trash"  style="font-size:2rem"></i>
                       </a>
                   </td>
               </tr> 
               <?php
